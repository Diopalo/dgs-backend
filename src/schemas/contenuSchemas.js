...
const createContenu = z.object({
  ...
  date_publication:  z.string().datetime({ message: 'date_publication doit être une date ISO 8601 valide.' }).optional().nullable(),
...
const updateContenu = z.object({
  ...
  date_publication: z.string().datetime().optional().nullable(),
  assigneA:         z.string().max(200).optional().nullable(),
  notes:            z.string().max(2000).optional().nullable(),
});
